                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <div class="header-right d-flex align-items-center justify-content-between">
                                <!-- Header Social -->
                                <ul class="header-social d-flex list-unstyled mb-0">
                                    <li class="me-2"><a href="https://www.fb.com/sai4ull"><i class="fab fa-facebook-f"></i></a></li>
                                    <li class="me-2"><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li class="me-2"><a href="#"><i class="fab fa-instagram"></i></a></li>
                                    <li class="me-2"><a href="#"><i class="fab fa-youtube"></i></a></li>
                                </ul>
                                <!-- Search Icon -->
                                <div class="nav-search search-switch me-3">
